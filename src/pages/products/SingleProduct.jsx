        ...
        <div className="px-8 font-outfit text-wenge-brown">
          ...
          <article className="bg-rose-white mt-6 p-5 rounded-xl">
            ...
            <ul className="list-disc mt-3 ml-8 text-lg marker:text-dark-raspberry">
              <li className="pl-3">
                <p>
                  <span className="font-semibold">Total: </span> <span>{totalTimeMinutes}</span> minutes
                </p>
              </li>
              <li className="mt-3 pl-3">
                <p><span className="font-semibold">Preparation: </span>{item?.more.prep_time}</p>
              </li>
              <li className="mt-3 pl-3">
                <p><span className="font-semibold">Cooking: </span>{item?.more.cook_time}</p>
              </li>
            </ul>
          </article>
          <div className="mt-8">
