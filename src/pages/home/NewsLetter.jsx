...
const NewsLetter = () => {
  return (
    ...
    <div className="mt-6 flex flex-col md:flex-row items-center justify-center w-full md:px-8 gap-4 mb-20">
        <input className="flex flex-grow px-4 py-4 rounded text-gray-500 outline-none  placeholder:text-[##1b2629]" placeholder="Name"/>
        <input className="flex flex-grow px-4 py-4 rounded text-gray-500 outline-none  placeholder:text-[##1b2629] " placeholder="Email Address"/>
